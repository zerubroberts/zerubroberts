...
Architecting scalable data infrastructure on modern cloud platforms. From data lakes to real-time streaming, building the foundation for analytics excellence.
...
**FinTech · Production · Enterprise Scale**
...
- Custom text classification models trained on historical email data
- Real-time inference pipeline with sub-second response times
- Automated response generation for routine inquiries
- Full MLOps implementation with MLFlow tracking and model versioning
...
`Python` `AWS SageMaker` `NLP` `Transformers` `MLFlow` `Docker`
...
**Utilities · Live Production · Multi-Region Deployment**

<img align="right" width="100" src="https://img.icons8.com/fluency/100/lightning-bolt.png"/>
...
- Real-time integration with Bureau of Meteorology weather APIs
- Geospatial analysis for infrastructure vulnerability mapping
- Custom alerting system with severity-based prioritization
- Dashboard for operations teams with drill-down capabilities

**Results:**
| Metric | Impact |
|:-------|:-------|
| Deployment | Live across Eastern Victoria |
| Maintenance | Shifted from reactive to proactive |
| Outage Duration | Significant reduction in average outage time |
| Cost Efficiency | Prevention-based cost savings |

`Python` `Ensemble Models` `Time Series` `Geospatial` `Real-time APIs` `Tableau`
...
**Construction · Active Deployment · Real-time Monitoring**
...
**Technical Implementation:**
- Custom object detection models trained on construction site imagery
- Integration with AWS Rekognition for robust detection
- Real-time video stream processing with OpenCV
- SMS alert system via Twilio for instant notifications
- Admin dashboard for compliance reporting and analytics

**Results:**
| Metric | Impact |
|:-------|:-------|
| Monitoring | 24/7 automated coverage |
| Response Time | Instant violation alerts |
| Compliance Rate | Measurable improvement in PPE adherence |
| Incidents | Reduction in safety incidents |

`Python` `OpenCV` `AWS Rekognition` `Computer Vision` `Twilio` `Real-time Processing`
...
**Customer Service · Production · Global Deployment**
...
**Technical Implementation:**
- Time series models (Prophet, ARIMA, LSTM) with ensemble averaging
- Feature engineering incorporating external signals
- Country-specific model variants for regional patterns
- Direct integration with workforce management systems
- Automated daily forecast updates with confidence intervals

**Results:**
| Metric | Impact |
|:-------|:-------|
| Accuracy | 74% MAPE across all channels |
| Planning Horizon | 4-week ahead forecasting |
| Integration | Direct roster management connection |
| Efficiency | Optimized staffing costs |

`Python` `Time Series` `Prophet` `LSTM` `Statistical Modeling` `API Integration`
...
✅ Qlik Data Architect
<br>✅ Qlik AutoML Implementation Specialist
<br>✅ Microsoft Professional Program in Data Science
<br>✅ Machine Learning Specialization (UW)
<br>✅ Azure Machine Learning (Microsoft)
<br>✅ Apache Spark Fundamentals
<br>✅ Google Cloud Platform (Computing & Security)
...
<img src="https://img.icons8.com/fluency/80/heat-map.png" width="50"/>
<br><br>
<a href="https://github.com/zerubroberts/qlik-risk-heatmap"><b>Risk Heatmap</b></a>
<br>
<sub>Risk matrix visualization extension for Qlik Sense. Display risk assessments with customizable color gradients and interactive tooltips.</sub>
<br><br>
...
<td align="center" width="33%">
<img src="https://img.icons8.com/fluency/80/speed.png" width="50"/>
<br><br>
<a href="https://github.com/zerubroberts/qlik-kpi-guage-card-extension"><b>KPI Gauge Card</b></a>
<br>
<sub>Display multiple gauge-style KPIs in a compact card format. Perfect for executive dashboards and at-a-glance metrics.</sub>
<br><br>
...
<td align="center" width="33%">
<img src="https://img.icons8.com/fluency/80/survey.png" width="50"/>
<br><br>
<a href="https://github.com/zerubroberts/qlik-sc-responses-visualizer"><b>Response Visualizer</b></a>
<br>
<sub>Visualize assessment and survey responses with clear, intuitive charts. Built for feedback analysis and response tracking.</sub>
<br><br>
...
<sub>📍 Melbourne, Australia · Open to remote collaboration worldwide</sub>
